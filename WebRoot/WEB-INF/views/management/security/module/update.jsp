...
<form method="post" action="<%=basePath %>/management/security/module/update" class="required-validate pageForm" onsubmit="return validateCallback(this, dialogAjaxDone);">
